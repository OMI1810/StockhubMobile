...
public class QRCodeScannerActivity extends AppCompatActivity {
    ...
    private void updateUI() {
        ...
        // Меняем цвет и иконку в зависимости от операции
        if ("shipment".equals(currentOperationType)) {
            operationTypeText.setTextColor(getResources().getColor(R.color.operation_shipment));
            operationTypeText.setCompoundDrawablesWithIntrinsicBounds(
                    getResources().getDrawable(android.R.drawable.ic_menu_upload),
                    null, null, null);
        } else {
            operationTypeText.setTextColor(getResources().getColor(R.color.operation_loading));
            operationTypeText.setCompoundDrawablesWithIntrinsicBounds(
                    getResources().getDrawable(android.R.drawable.ic_menu_save),
                    null, null, null);
        }
        operationTypeText.setCompoundDrawablePadding(8);
    }
    ...
    private void handleProductInfoSuccess(ProductInfoResponse response, String barcode, String format, String timestamp) {
        ...
        databaseHelper.addOrUpdateScannedProduct(product);
